...
public class RebindKeys : MonoBehaviour {
    ...
    public void StartRebinding() {
        ...
        rebindingOperation = inputAction.action.PerformInteractiveRebinding().WithControlsExcluding("Mouse").OnMatchWaitForAnother(0.1f).OnComplete(operation => RebindComplete()).Start();
